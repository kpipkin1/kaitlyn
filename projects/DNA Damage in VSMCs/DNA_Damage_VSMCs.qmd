...
In this step I wrote a function called "plot_day()". I then use the
argument, "day_label" to create a boxplot showing DNA damage across
...
In this final step, I am using the gt package to make a table of all of
the combined data and analysis that I performed in all of the previous
steps.
